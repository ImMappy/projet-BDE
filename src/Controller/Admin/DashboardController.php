...
class DashboardController extends AbstractDashboardController
{
    ...
    {
        return parent::configureUserMenu($user)->setName($user->getUserIdentifier())->displayUserName() ->addMenuItems([
            MenuItem::linkToRoute('My Profile', 'fa fa-id-card', 'user_show'),
